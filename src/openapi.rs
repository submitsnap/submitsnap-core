...
use crate::{
    modules::{
        ...
        form::{handler as form_handlers, public as public_handlers},
        identity::handler as identity_handlers,
        organization::handler as organization_handlers,
        webhook::handler as webhook_handlers,
    },
...
#[openapi(
    paths(
        ...
        form_handlers::create_form,
        form_handlers::list_forms,
        form_handlers::get_form,
        form_handlers::update_form,
        form_handlers::delete_form,
        form_handlers::publish_form,
        form_handlers::close_form,
        form_handlers::rotate_public_id,
        form_handlers::list_submissions,
        form_handlers::list_form_submissions,
        form_handlers::get_submission,
        form_handlers::update_submission,
        form_handlers::delete_submission,
        form_handlers::export_submissions,
        webhook_handlers::create_endpoint,
        webhook_handlers::list_endpoints,
        webhook_handlers::get_endpoint,
        webhook_handlers::update_endpoint,
        webhook_handlers::delete_endpoint,
        webhook_handlers::rotate_secret,
        webhook_handlers::list_deliveries,
        webhook_handlers::redeliver,
        public_handlers::definition,
        public_handlers::submit,
    ...
    components(schemas(
        ...
        crate::modules::form::validation::FormSchema,
        crate::modules::form::validation::FieldDefinition,
        crate::modules::form::validation::FieldType,
        crate::modules::form::model::FormStatus,
        crate::modules::form::model::SubmissionStatus,
        crate::modules::form::dto::CreateFormRequest,
        crate::modules::form::dto::UpdateFormRequest,
        crate::modules::form::dto::FormResponse,
        crate::modules::form::dto::FormListResponse,
        crate::modules::form::dto::PublicFormResponse,
        crate::modules::form::dto::SubmissionAcceptedResponse,
        crate::modules::form::dto::SubmissionResponse,
        crate::modules::form::dto::SubmissionListResponse,
        crate::modules::form::dto::UpdateSubmissionRequest,
        crate::modules::form::dto::ExportFormat,
        crate::modules::form::model::SubmissionStatus,
        crate::modules::webhook::model::DeliveryStatus,
        crate::modules::webhook::dto::CreateWebhookEndpointRequest,
        crate::modules::webhook::dto::UpdateWebhookEndpointRequest,
        crate::modules::webhook::dto::WebhookEndpointResponse,
        crate::modules::webhook::dto::WebhookEndpointListResponse,
        crate::modules::webhook::dto::WebhookSecretResponse,
        crate::modules::webhook::dto::WebhookDeliveryResponse,
        crate::modules::webhook::dto::WebhookDeliveryListResponse,
        ErrorResponse,
        HealthResponse,
    )),
    ...
    tags(
        ...
        (name = "forms", description = "Forms and their lifecycle"),
        (
            name = "submissions",
            description = "The submission inbox, and export"
        ),
        (
            name = "webhooks",
            description = "Signed delivery of submissions to an HTTP endpoint"
        ),
        (name = "public", description = "The public form endpoints, outside the API prefix"),
